...
class TransformerNet(nn.Module):
    def __init__(self,vocab:Vocab):
        ...
        self.embedding = nn.Embedding(num_embeddings=len(vocab.vocab_dic), embedding_dim=256)
        self.pe= PositionalEncoding(256)
        self.transformer = nn.Transformer(batch_first=True,d_model=256)

        self.fc = nn.Linear(in_features=256, out_features=len(vocab.vocab_dic))
