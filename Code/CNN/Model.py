...
class Block(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.relu(x)
        return x
class ResNeXttest(nn.Module):
    def __init__(self,num_block, block=Block,input_channels=3, num_classes=1000, groups=32, width_per_group=4):
        super(ResNeXttest, self).__init__()
        self.in_channel = 64
